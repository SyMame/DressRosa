package com.example.myEcom.networksync;
    ...
    public void checkConnection(){
        ...
        if(!isInternetConnected()) {
                ...
                final FancyAlertDialog.Builder alert = new FancyAlertDialog.Builder(ctx)
                        ...
                        .setTextTitle("Pas d'internet")
                        .setTextSubTitle("Impossible de se connecter à un serveur")
                        .setBody(R.string.noconnection)
                        .setPositiveButtonText("Se connecter maintenant")
