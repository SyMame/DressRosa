...
import com.example.myEcom.models.SingleProductModel;
...
public class IndividualProduct extends AppCompatActivity {
    ...
    public void shareProduct(View view) {
        ...
        String shareBody = "Found amazing " + productname.getText().toString() + "on DressRosa";
    ...
    public void increment(View view) {
        if (quantity < 500) {
            ...
            Toasty.error(IndividualProduct.this, "Le nombre de produits doit être inférieur à 500", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void addToCart(View view) {
        ...
        if ( customheader.getText().toString().length() == 0 ||  custommessage.getText().toString().length() ==0 ){
            ...
            Snackbar.make(view, "Veuillez saisir la taille et la couleur souhaitée", Snackbar.LENGTH_LONG)
            ...
            Toasty.success(IndividualProduct.this, "Article ajouté", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void goToCart(View view) {
        ...
        if ( customheader.getText().toString().length() == 0 ||  custommessage.getText().toString().length() ==0 ){
            ...
            Snackbar.make(view, "Veuillez entrer la taille et la couleur souhaitée", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }else {
            mDatabaseReference.child("cart").child(usermobile).push().setValue(getProductObject());
            session.increaseCartValue();
