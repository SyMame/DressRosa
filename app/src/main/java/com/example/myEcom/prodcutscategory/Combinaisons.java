...
public class Combinaisons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder>(
                ...
                mDatabaseReference.child("Products").child("Combinaisons").getRef()
        ) {
            @Override
            protected void populateViewHolder(final Cards.MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                Picasso.with(Combinaisons.this).load(model.getCardimage()).into(viewHolder.cardimage);

                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Combinaisons.this, IndividualProduct.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Combinaisons.this, Cart.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        startActivity(new Intent(Combinaisons.this, NotificationActivity.class));
        finish();
    }
