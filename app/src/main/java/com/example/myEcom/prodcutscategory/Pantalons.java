...
public class Pantalons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder>(
                ...
                mDatabaseReference.child("Products").child("Pantalons").getRef()
        ) {
            @Override
            protected void populateViewHolder(final Cards.MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                Picasso.with(Pantalons.this).load(model.getCardimage()).into(viewHolder.cardimage);

                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Pantalons.this, IndividualProduct.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Pantalons.this, Cart.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        startActivity(new Intent(Pantalons.this, NotificationActivity.class));
        finish();
    }
