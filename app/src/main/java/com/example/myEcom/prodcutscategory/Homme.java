...
public class Homme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder>(
                ...
                mDatabaseReference.child("Products").child("Homme").getRef()
        ) {
            @Override
            protected void populateViewHolder(final Cards.MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                Picasso.with(Homme.this).load(model.getCardimage()).into(viewHolder.cardimage);

                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Homme.this, IndividualProduct.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Homme.this, Cart.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        startActivity(new Intent(Homme.this, NotificationActivity.class));
        finish();
    }
